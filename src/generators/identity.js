...
export function generateIdentitySvg(data) {
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 ${width} ${height}" width="100%" height="${height}" fill="none">
    ...
    <g transform="translate(42, 68)">
      <!-- Outer Frame -->
      <rect x="0" y="0" width="245" height="206" rx="16" fill="${theme.colors.accentBlush}" stroke="${theme.colors.border}" stroke-width="0.8" />
      
      <!-- Inner White Portrait Bezel -->
      <rect x="12" y="12" width="221" height="126" rx="12" fill="#FFFFFF" stroke="${theme.colors.borderSubtle}" stroke-width="0.8" />
      ...
      <text x="122.5" y="70" text-anchor="middle" class="editorial-title" font-size="22" font-weight="800" fill="${theme.colors.deepCharcoal}">
        SP
      </text>
      ...
      <text x="58" y="121.5" class="code-mono" font-size="8.5" font-weight="700" fill="${theme.colors.deepCharcoal}" letter-spacing="0.06em">
        VERIFIED BUILDER · CGPA ${escapeXml(cgpa)}
      </text>

      <!-- Identity Meta beneath portrait -->
      <text x="122.5" y="164" text-anchor="middle" class="editorial-sans" font-size="14" font-weight="800" fill="${theme.colors.deepCharcoal}">
        ${escapeXml(name)}
      </text>
      <text x="122.5" y="184" text-anchor="middle" class="code-mono" font-size="9" font-weight="600" fill="${theme.colors.barbiePink}" letter-spacing="0.06em">
    ...
    <g transform="translate(315, 68)">
      ...
      <g transform="translate(0, 32)">
        <rect x="0" y="0" width="583" height="56" rx="12" fill="${theme.colors.accentBlush}" stroke="${theme.colors.border}" stroke-width="0.8" />
        ...
        <text x="16" y="44" class="code-mono" font-size="9" fill="${theme.colors.barbiePink}" font-weight="700" letter-spacing="0.06em">
    ...
    ${renderSparkle(278, 260, 9, theme.colors.dreamhouseBlush)}
  </svg>`;
}
